...
rm $ROOT_DIR/build/jsb-link/frameworks/runtime-src/proj.android-studio/app/res/values/strings.xml
rm $ROOT_DIR/build/jsb-link/frameworks/runtime-src/proj.android-studio/app/AndroidManifest.xml
rm $ROOT_DIR/settings/builder.json
