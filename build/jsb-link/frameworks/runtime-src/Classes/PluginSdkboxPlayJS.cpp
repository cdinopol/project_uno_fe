...
static bool js_PluginSdkboxPlayJS_PluginSdkboxPlay_getPlayerScores(se::State& s)
{
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 4) {
        ...
        SE_PRECONDITION2(ok, false, "js_PluginSdkboxPlayJS_PluginSdkboxPlay_getPlayerScores : Error processing arguments");
        sdkbox::PluginSdkboxPlay::getPlayerScores(arg0, arg1, arg2, arg3);
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 4);
    return false;
}
SE_BIND_FUNC(js_PluginSdkboxPlayJS_PluginSdkboxPlay_getPlayerScores)
...
static bool js_PluginSdkboxPlayJS_PluginSdkboxPlay_setGDPR(se::State& s)
{
    const auto& args = s.args();
    size_t argc = args.size();
    CC_UNUSED bool ok = true;
    if (argc == 1) {
        ...
        SE_PRECONDITION2(ok, false, "js_PluginSdkboxPlayJS_PluginSdkboxPlay_setGDPR : Error processing arguments");
        sdkbox::PluginSdkboxPlay::setGDPR(arg0);
        return true;
    }
    SE_REPORT_ERROR("wrong number of arguments: %d, was expecting %d", (int)argc, 1);
    return false;
}
SE_BIND_FUNC(js_PluginSdkboxPlayJS_PluginSdkboxPlay_setGDPR)
...
static bool js_PluginSdkboxPlayJS_PluginSdkboxPlay_generateIdentityVerificationSignature(se::State& s)
{
    const auto& args = s.args();
    size_t argc = args.size();
    if (argc == 0) {
...
SE_BIND_FUNC(js_PluginSdkboxPlayJS_PluginSdkboxPlay_generateIdentityVerificationSignature)
...
bool js_register_PluginSdkboxPlayJS_PluginSdkboxPlay(se::Object* obj)
{
    ...
    cls->defineStaticFunction("getPlayerScores", _SE(js_PluginSdkboxPlayJS_PluginSdkboxPlay_getPlayerScores));
    ...
    cls->defineStaticFunction("setGDPR", _SE(js_PluginSdkboxPlayJS_PluginSdkboxPlay_setGDPR));
    cls->defineStaticFunction("loadAchievements", _SE(js_PluginSdkboxPlayJS_PluginSdkboxPlay_loadAchievements));
    cls->defineStaticFunction("generateIdentityVerificationSignature", _SE(js_PluginSdkboxPlayJS_PluginSdkboxPlay_generateIdentityVerificationSignature));
